          ...
          <div className="mt-6 grid items-center lg:grid-cols-2 border border-gray-200 rounded-lg justify-items-center px-5">
            ...
            <div className="divide-y divide-gray-200 dark:divide-grayborder-gray-200 py-5">
             ...
             p
              ...
              {/* <div className="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-4356c2ce" data-id="4356c2ce" data-element_type="column">
                <div className="elementor-widget-wrap elementor-element-populated">
                  <div className="elementor-element elementor-element-b4b85cb elementor-widget elementor-widget-shortcode" data-id="b4b85cb" data-element_type="widget" data-widget_type="shortcode.default">
                    <div className="elementor-widget-container">
                      <div className="elementor-shortcode"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3965.1232723209605!2d106.94041861477004!3d-6.3780844953848135!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNsKwMjInNDEuMSJTIDEwNsKwNTYnMzMuNCJF!5e0!3m2!1sid!2sid!4v1594696636451!5m2!1sid!2sid" width="600" height="450" ></iframe></div>
                    </div>
                  </div>
                </div>
              </div> */}
